...
@objc(NfcPlugin) class NfcPlugin: CDVPlugin {
    var nfcController: NSObject? // NFCController downCast as NSObject for iOS version compatibility
    ...
    func connect(command: CDVInvokedUrlCommand) {
        ...
        DispatchQueue.main.async {
            ...
            (self.nfcController as! NFCController).initSession(alertMessage: "Bring your phone close to the Tap.", completed: {
                (error: Error?) -> Void in
    ...
    func transceive(command: CDVInvokedUrlCommand) {
        ...
        DispatchQueue.main.async {
            ...
            (self.nfcController as! NFCController).send(request: request, completed: {
