...
var NFC = /** @class */ (function (_super) {
    ...
    //THV add
    NFC.prototype.beginNDEFSession = function (onSuccess, onFailure) { return cordova(this, "beginNDEFSession", { "observable": true, "successIndex": 0, "errorIndex": 3, "clearFunction": "invalidateSession", "clearWithArgs": true }, arguments); };

    NFC.prototype.invalidateNDEFSession = function (onSuccess, onFailure) { return cordova(this, "invalidateNDEFSession", { "observable": true, "successIndex": 0, "errorIndex": 3, "clearFunction": "invalidateSession", "clearWithArgs": true }, arguments); };

    NFC.prototype.connect = function (tech, timeout, onSuccess, onFailure) { return cordova(this, "connect", { "otherPromise": true, "successIndex": 2, "errorIndex": 5 }, arguments); };
